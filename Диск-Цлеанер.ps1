...
#GUI Variables
$FormTitleText = "Чистач диска од Џима Тајлера (ПоверСхеллЕнгинеер.цом)"
$SelectDiskLabelText = "Изабери диск:"
$FreeSpaceLabelText = "Слободан простор (гигабајти): "
$TotalSpaceLabelText = "Укупан простор (гигабајти): "
$JunkFoundLabelText = "пронађено смеће (гигабајти):"
$CleanDiskBtnText = "Очисти диск *Избриши датотеке*"
$SpaceCleanedLabelText = "Очишћени простор (гигабајти): "
$LogFileLabelText = "Пронађена датотека евиденције: $абцдефг"
$CreditLabelText = "Скрипта Џима Тајлера - ПоверСхеллЕнгинеер.цом"
$LogFileLocatedText = "Пронађена датотека евиденције"
$AnalyzingDriveText = "Анализа дискова..."
$BrowsersAreRunningText = "Претраживачи раде... Обавести корисника..."
$PleaseCloseBrowsersText = "Затворите све веб претраживаче и покушајте поново."
$CleaningDriveText = "Чишћење диск јединице..."
